  ...
  return (
    <ScrollBox p="m" backgroundColor={'white'} flex={1}>
      <Box alignItems="center">
        <Input label="Type" onChangeText={text => setName(text)} value={name} />
        <Image style={styles.imageStyles} source={images.rainHeadDimensions} />
        <DataTable style={styles.tableContainer}>
          <DataTable.Header style={{marginHorizontal: -15}}>
            <DataTable.Title
              textStyle={styles.tableText}
              style={[styles.border, {flex: 2}]}>
              Dimension
            </DataTable.Title>
            <DataTable.Title
              textStyle={styles.tableText}
              style={[styles.border, {flex: 5}]}>
              Description
            </DataTable.Title>
            <DataTable.Title
              textStyle={styles.tableText}
              style={[styles.border, {flex: 3}]}>
              Length
            </DataTable.Title>
          </DataTable.Header>
