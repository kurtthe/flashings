        ...
        <View style={styles.container}>
          <View style={styles.socialConnect}>
            ...
            <Text style={styles.mainTextStyle}>
              Want to access the Burdens Flashing Designer? You'll need to open
              a Burdens Trade account to get in.
            </Text>
          </View>
          <View style={{ flex: 2 }}>
            ...
            <View>
              ...
              <View>
                ...
                <Text style={styles.underlinedTextStyle}>03 9703 8400</Text>
              </View>
            </View>
          </View>
          <Box flex={1} style={{ justifyContent: 'space-around' }}>
